...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('NFLK Updates', url='http://telegram.me/ProjectNetflixLK'),
        InlineKeyboardButton('My Master', url='https://telegram.me/Zitron_Kenway')
    ]]
...
Made With Love ❤️ By @ProjectNetflixLK</b>""",
